...
count lightout,80,w3
count lightout,150,w4
count lightout,1500,w5
sertxd("    2% ",#w1,"  ",#w2,"   ",#w3,"   ",#w4,"   ",#w5,cr,lf)
high lights2
wait 5
...
count lightout,150,w4
count lightout,1500,w5
sertxd("    20% ",#w1,"  ",#w2,"   ",#w3,"   ",#w4,"   ",#w5,cr,lf)
high lights2
wait 5
...
count lightout,150,w4
count lightout,1500,w5
sertxd("    100% ",#w1,"  ",#w2,"   ",#w3,"   ",#w4,"   ",#w5,cr,lf)
high lights2
wait 5
