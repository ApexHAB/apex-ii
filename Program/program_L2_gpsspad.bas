...
b16 = 0			'copy contents of b0-12 onto b20-32
for b15 = 20 to 30
	peek b16,b17
	poke b15,b17
	b16 = b16 + 1
...
if b16 > 0 then
for b17 = 0 to 2		'write time to RTC RAM

	b10 = ramptr
	ramptr = ramptr + 2
	b11 = b20
	b12 = b20 + 1
	gosub RTCRAMWriteManySpad
	b20 = b20 + 2
	if b17 < 2 then
		gosub WriteColon
	endif
...
if b24 <> 0	then			'write lat to RTC RAM
	if b24 = "S" then
		gosub WriteMinus	
	endif
	b10 = ramptr	
...
if b27 <> 0	then			'write long to RTC RAM
	if b27 = "W" then
		gosub WriteMinus	
	endif
	b10 = ramptr	
...
if b30 = 1 then	'write altitude
	...
	ptr = b28			'copy out of spad into b1-5
	for b15 = 1 to 5
		peek @ptrinc,b16
		poke b15,b16
	next
...
RTCRAMWriteManySpad:
'writes a number of bytes to ram from the PIC spad RAM
'b10 - RTCRAM start addr
'b11 - PIC RAM start addr
'b12 - PIC RAM end addr
...
setfreq m8
ptr=0
serin [2000,endgps1],GPSIn2,T4800,("GPGGA,"),@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc,@ptrinc
...
'b4 = N/S; otherwise no fix = 0
'b5 = start of long pointer
'b6 = end of long pointer
'b7 = E/W; otherwise no fix = 0
